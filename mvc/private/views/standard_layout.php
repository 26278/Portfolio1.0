        ...
        <div class="head">
            <div class="head__content">
                ...
                <span onclick="openNav()">
                    <svg class="head__nav" width="24" height="24" viewBox="0 0 24 24"><path d="M0 0h24v24H0z" fill="none"/><path d="M3 18h18v-2H3v2zm0-5h18v-2H3v2zm0-7v2h18V6H3z"/></svg>
                    </span>
            </div>
    ...
    <footer class="footer">
        <div class="foot">
            <div class="foot__copyright">
                <p class="foot__copyright__text">&copy; Copyright <?php echo date( 'Y' ) ?></p>
                <p class="foot__copyright__text">Jochem de Wit</p>
            </div>
            <div class="foot__media">
                <a class="foot__media__a" href="">LinkedIn</a>
                <a class="foot__media__a" href="">Instagram</a>
                <a class="foot__media__a" href="">GitHub</a>
            </div>
        </div>
